...
public:
  ...
  material_properties& add(G4String const& key, G4double value, G4bool boolean); //ITS   
  material_properties& add(G4String const& key, vec const& energies, vec const& values, const G4int integer); //ITS     
